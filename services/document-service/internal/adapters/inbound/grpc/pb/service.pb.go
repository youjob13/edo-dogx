...
type DocumentVersion struct {
	...
	Status              string                 `protobuf:"bytes,11,opt,name=status,proto3" json:"status,omitempty"`
	ChangedByUserName   string                 `protobuf:"bytes,12,opt,name=changed_by_user_name,json=changedByUserName,proto3" json:"changed_by_user_name,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *DocumentVersion) GetChangedByUserName() string {
	if x != nil {
...
type WorkflowInstance struct {
	...
	SubmittedByUserName string                 `protobuf:"bytes,13,opt,name=submitted_by_user_name,json=submittedByUserName,proto3" json:"submitted_by_user_name,omitempty"`
	ApproverUserName    string                 `protobuf:"bytes,14,opt,name=approver_user_name,json=approverUserName,proto3" json:"approver_user_name,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *WorkflowInstance) GetSubmittedByUserName() string {
	if x != nil {
...
func (x *WorkflowInstance) GetApproverUserName() string {
	if x != nil {
...
type WorkflowEvent struct {
	...
	ActorUserName   string                 `protobuf:"bytes,11,opt,name=actor_user_name,json=actorUserName,proto3" json:"actor_user_name,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *WorkflowEvent) GetActorUserName() string {
	if x != nil {
...
const file_service_proto_rawDesc = "" +
	...
	"\rowner_user_id\x18\x04 \x01(\tR\vownerUserId\x12\x18\n" +
	"\aversion\x18\x05 \x01(\x03R\aversion\x12\x1d\n" +
	"\n" +
	"updated_at\x18\x06 \x01(\tR\tupdatedAt\x122\n" +
	"\x15content_document_json\x18\a \x01(\tR\x13contentDocumentJson\x12&\n" +
	"\x0fowner_user_name\x18\b \x01(\tR\rownerUserName\x12\x1d\n" +
	"\n" +
	"object_key\x18\t \x01(\tR\tobjectKey\x12*\n" +
	"\x11object_version_id\x18\n" +
	" \x01(\tR\x0fobjectVersionId\x12\x16\n" +
	"\x06status\x18\v \x01(\tR\x06status\"\xc6\x03\n" +
	"\x0fDocumentVersion\x12\x1f\n" +
	"\vdocument_id\x18\x01 \x01(\tR\n" +
	"documentId\x12%\n" +
	"\x0eversion_number\x18\x02 \x01(\x03R\rversionNumber\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x1a\n" +
	"\bcategory\x18\x04 \x01(\tR\bcategory\x12+\n" +
	"\x12changed_by_user_id\x18\x05 \x01(\tR\x0fchangedByUserId\x12%\n" +
	"\x0echange_summary\x18\x06 \x01(\tR\rchangeSummary\x12\x1d\n" +
	"\n" +
	"created_at\x18\a \x01(\tR\tcreatedAt\x12\x1d\n" +
	"\n" +
	"object_key\x18\b \x01(\tR\tobjectKey\x12*\n" +
	"\x11object_version_id\x18\t \x01(\tR\x0fobjectVersionId\x122\n" +
	"\x15content_document_json\x18\n" +
	" \x01(\tR\x13contentDocumentJson\x12\x16\n" +
	"\x06status\x18\v \x01(\tR\x06status\x12/\n" +
	"\x14changed_by_user_name\x18\f \x01(\tR\x11changedByUserName\"\xab\x02\n" +
	...
	"\x11submitted_version\x18\a \x01(\x03R\x10submittedVersion\x12/\n" +
	"\x14submitted_by_user_id\x18\b \x01(\tR\x11submittedByUserId\x12(\n" +
	"\x10approver_user_id\x18\t \x01(\tR\x0eapproverUserId\x12)\n" +
	"\x10decision_comment\x18\n" +
	" \x01(\tR\x0fdecisionComment\x12!\n" +
	"\fsubmitted_at\x18\v \x01(\tR\vsubmittedAt\x12\x1d\n" +
	"\n" +
	"decided_at\x18\f \x01(\tR\tdecidedAt\x123\n" +
	"\x16submitted_by_user_name\x18\r \x01(\tR\x13submittedByUserName\x12,\n" +
	"\x12approver_user_name\x18\x0e \x01(\tR\x10approverUserName\"\xfa\x02\n" +
	...
	"\x10document_version\x18\b \x01(\x03R\x0fdocumentVersion\x12\x18\n" +
	"\acomment\x18\t \x01(\tR\acomment\x12\x1f\n" +
	"\voccurred_at\x18\n" +
	" \x01(\tR\n" +
	"occurredAt\x12&\n" +
	"\x0factor_user_name\x18\v \x01(\tR\ractorUserName\"c\n" +
	"\x1aListWorkflowEventsResponse\x12/\n" +
	"\x05items\x18\x01 \x03(\v2\x19.service.v1.WorkflowEventR\x05items\x12\x14\n" +
	...
	"\n" +
	"board_role\x18\x05 \x01(\tR\tboardRole\x12\x14\n" +
	"\x05roles\x18\x06 \x03(\tR\x05roles\"c\n" +
	"\x0eTaskAttachment\x12\x1f\n" +
	"\vdocument_id\x18\x01 \x01(\tR\n" +
	"documentId\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x1a\n" +
	"\bcategory\x18\x03 \x01(\tR\bcategory\"\xe5\x04\n" +
	"\x04Task\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	...
	"\x04task\x18\x01 \x01(\v2\x10.service.v1.TaskR\x04task\"\xab\x01\n" +
	"\x10ListTasksRequest\x12\"\n" +
	"\ractor_user_id\x18\x01 \x01(\tR\vactorUserId\x12(\n" +
	"\x10assignee_user_id\x18\x02 \x01(\tR\x0eassigneeUserId\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x12\x1b\n" +
	"\ttask_type\x18\x04 \x01(\tR\btaskType\x12\x14\n" +
	"\x05limit\x18\x05 \x01(\x05R\x05limit\";\n" +
	"\x11ListTasksResponse\x12&\n" +
	"\x05tasks\x18\x01 \x03(\v2\x10.service.v1.TaskR\x05tasks\"\xb5\x01\n" +
	...
	"\x10decision_comment\x18\x04 \x01(\tR\x0fdecisionComment\x12\x1a\n" +
	"\bdecision\x18\x05 \x01(\tR\bdecision\"@\n" +
	"\x18UpdateTaskStatusResponse\x12$\n" +
	"\x04task\x18\x01 \x01(\v2\x10.service.v1.TaskR\x04task\"\x82\x01\n" +
	"\x19UpdateTaskAssigneeRequest\x12\"\n" +
	"\ractor_user_id\x18\x01 \x01(\tR\vactorUserId\x12\x17\n" +
	"\atask_id\x18\x02 \x01(\tR\x06taskId\x12(\n" +
	"\x10assignee_user_id\x18\x03 \x01(\tR\x0eassigneeUserId\"B\n" +
	...
	"\ractor_user_id\x18\x01 \x01(\tR\vactorUserId\x12\x17\n" +
	"\atask_id\x18\x02 \x01(\tR\x06taskId\"\xc2\x02\n" +
	...
	"canApprove\x12+\n" +
	"\x12can_move_to_review\x18\x06 \x01(\bR\x0fcanMoveToReview\x12\x1d\n" +
	"\n" +
	"can_assign\x18\a \x01(\bR\tcanAssign\x12\x1f\n" +
	"\vcan_comment\x18\b \x01(\bR\n" +
	"canComment\"\x88\x01\n" +
	"\x19AvailableApproversRequest\x12\"\n" +
	"\ractor_user_id\x18\x01 \x01(\tR\vactorUserId\x12\x19\n" +
	...
	"\x06member\x18\x01 \x01(\v2\x17.service.v1.BoardMemberR\x06member\"\xf0\x01\n" +
	...
	"\x06member\x18\x01 \x01(\v2\x17.service.v1.BoardMemberR\x06member\x12\x18\n" +
	"\acreated\x18\x02 \x01(\bR\acreated\"\xa2\x01\n" +
	"\fDocumentItem\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x1a\n" +
	"\bcategory\x18\x03 \x01(\tR\bcategory\x12\x1d\n" +
	"\n" +
	"updated_at\x18\x04 \x01(\tR\tupdatedAt\x12\x17\n" +
	"\asize_kb\x18\x05 \x01(\x05R\x06sizeKb\x12\x18\n" +
	"\aversion\x18\x06 \x01(\x05R\aversion\"\xbc\x01\n" +
	"\x19AvailableDocumentsRequest\x12\"\n" +
	"\ractor_user_id\x18\x01 \x01(\tR\vactorUserId\x12\x19\n" +
	...
	"\x15content_document_json\x18\x04 \x01(\tR\x13contentDocumentJson\"\xce\x01\n" +
	...
	"\x15content_document_json\x18\x05 \x01(\tR\x13contentDocumentJson\"Y\n" +
	...
	"\tfile_name\x18\x02 \x01(\tR\bfileName\x12\x1b\n" +
	"\tmime_type\x18\x03 \x01(\tR\bmimeType\"\x9c\x01\n" +
	...
	"\x1cListDocumentVersionsResponse\x121\n" +
	"\x05items\x18\x01 \x03(\v2\x1b.service.v1.DocumentVersionR\x05items\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x05R\x05total\"\x87\x01\n" +
	"\x19GetDocumentVersionRequest\x12\"\n" +
	"\ractor_user_id\x18\x01 \x01(\tR\vactorUserId\x12\x1f\n" +
	"\vdocument_id\x18\x02 \x01(\tR\n" +
	"documentId\x12%\n" +
	"\x0eversion_number\x18\x03 \x01(\x03R\rversionNumber\"\x88\x01\n" +
	...
	"\x10expected_version\x18\x04 \x01(\x03R\x0fexpectedVersion\"\xb1\x01\n" +
	"\x15SubmitWorkflowRequest\x12\"\n" +
	"\ractor_user_id\x18\x01 \x01(\tR\vactorUserId\x12\x1f\n" +
	"\vdocument_id\x18\x02 \x01(\tR\n" +
	"documentId\x12(\n" +
	"\x10approver_user_id\x18\x03 \x01(\tR\x0eapproverUserId\x12)\n" +
	"\x10expected_version\x18\x04 \x01(\x03R\x0fexpectedVersion\"\x88\x01\n" +
	...
	"documentId\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\x05R\x05limit\x12\x16\n" +
	"\x06offset\x18\x04 \x01(\x05R\x06offset\"\x93\x01\n" +
	...
	"\adeleted\x18\x05 \x01(\bR\adeleted\"U\n" +
	"\x1cSyncSearchProjectionResponse\x12\x16\n" +
	"\x06synced\x18\x01 \x01(\bR\x06synced\x12\x1d\n" +
	"\n" +
	"indexed_at\x18\x02 \x01(\tR\tindexedAt\"\xb7\x01\n" +
	"\x13SearchGlobalRequest\x12\"\n" +
	"\ractor_user_id\x18\x01 \x01(\tR\vactorUserId\x12\x14\n" +
	"\x05query\x18\x02 \x01(\tR\x05query\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\x05R\x05limit\x12\x16\n" +
	"\x06offset\x18\x04 \x01(\x05R\x06offset\x128\n" +
	"\bentities\x18\x05 \x03(\x0e2\x1c.service.v1.SearchEntityTypeR\bentities\"\xea\x03\n" +
	"\tSearchHit\x12=\n" +
	"\ventity_type\x18\x01 \x01(\x0e2\x1c.service.v1.SearchEntityTypeR\n" +
	"entityType\x12\x0e\n" +
	...
	"\x05route\x18\a \x01(\tR\x05route\x12\x1f\n" +
	"\vdocument_id\x18\b \x01(\tR\n" +
	"documentId\x12\x17\n" +
	"\atask_id\x18\t \x01(\tR\x06taskId\x12\x19\n" +
	"\bboard_id\x18\n" +
	" \x01(\tR\aboardId\x12\x1a\n" +
	...
	"\x10assignee_user_id\x18\x0e \x01(\tR\x0eassigneeUserId\x12(\n" +
	"\x10approver_user_id\x18\x0f \x01(\tR\x0eapproverUserId\"Y\n" +
	"\x14SearchGlobalResponse\x12+\n" +
	"\x05items\x18\x01 \x03(\v2\x15.service.v1.SearchHitR\x05items\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x05R\x05total\"\xc8\x03\n" +
	"\rActivityEvent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12'\n" +
	"\x0forganization_id\x18\x02 \x01(\tR\x0eorganizationId\x12\"\n" +
	"\ractor_user_id\x18\x03 \x01(\tR\vactorUserId\x12&\n" +
	"\x0factor_user_name\x18\x04 \x01(\tR\ractorUserName\x12D\n" +
	"\ventity_type\x18\x05 \x01(\x0e2#.service.v1.ActivityEventEntityTypeR\n" +
	"entityType\x12\x1b\n" +
	"\tentity_id\x18\x06 \x01(\tR\bentityId\x12?\n" +
	"\vaction_type\x18\a \x01(\x0e2\x1e.service.v1.ActivityActionTypeR\n" +
	"actionType\x12\x18\n" +
	...
	"\bboard_id\x18\f \x01(\tR\aboardId\"\xac\x01\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x19.service.v1.ActivityEventR\x05items\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x05R\x05total*t\n" +
	"\x10SearchEntityType\x12\"\n" +
	"\x1eSEARCH_ENTITY_TYPE_UNSPECIFIED\x10\x00\x12\x1f\n" +
	"\x1bSEARCH_ENTITY_TYPE_DOCUMENT\x10\x01\x12\x1b\n" +
	"\x17SEARCH_ENTITY_TYPE_TASK\x10\x02*\x93\x01\n" +
	"\x17ActivityEventEntityType\x12*\n" +
	"&ACTIVITY_EVENT_ENTITY_TYPE_UNSPECIFIED\x10\x00\x12'\n" +
	"#ACTIVITY_EVENT_ENTITY_TYPE_DOCUMENT\x10\x01\x12#\n" +
	"\x1fACTIVITY_EVENT_ENTITY_TYPE_TASK\x10\x02*\xca\x04\n" +
	"\x12ActivityActionType\x12$\n" +
	" ACTIVITY_ACTION_TYPE_UNSPECIFIED\x10\x00\x12)\n" +
	"%ACTIVITY_ACTION_TYPE_DOCUMENT_CREATED\x10\x01\x12)\n" +
	"%ACTIVITY_ACTION_TYPE_DOCUMENT_UPDATED\x10\x02\x12+\n" +
	"'ACTIVITY_ACTION_TYPE_DOCUMENT_SUBMITTED\x10\x03\x12*\n" +
	"&ACTIVITY_ACTION_TYPE_DOCUMENT_APPROVED\x10\x04\x12)\n" +
	"%ACTIVITY_ACTION_TYPE_EXPORT_REQUESTED\x10\x05\x12)\n" +
	"%ACTIVITY_ACTION_TYPE_EXPORT_SUCCEEDED\x10\x06\x12&\n" +
	"\"ACTIVITY_ACTION_TYPE_EXPORT_FAILED\x10\a\x12%\n" +
	"!ACTIVITY_ACTION_TYPE_TASK_CREATED\x10\b\x12,\n" +
	"(ACTIVITY_ACTION_TYPE_TASK_STATUS_UPDATED\x10\t\x12.\n" +
	"*ACTIVITY_ACTION_TYPE_TASK_ATTACHMENT_ADDED\x10\n" +
	"\x120\n" +
	",ACTIVITY_ACTION_TYPE_TASK_ATTACHMENT_REMOVED\x10\v\x12*\n" +
	"&ACTIVITY_ACTION_TYPE_TASK_MEMBER_ADDED\x10\f2K\n" +
	"\x0eExampleService\x129\n" +
	"\x04Ping\x12\x17.service.v1.PingRequest\x1a\x18.service.v1.PingResponse2\xf7\f\n" +
	...
	"\x0fSearchDocuments\x12\".service.v1.SearchDocumentsRequest\x1a#.service.v1.SearchDocumentsResponse\x12i\n" +
	"\x14ListDocumentVersions\x12'.service.v1.ListDocumentVersionsRequest\x1a(.service.v1.ListDocumentVersionsResponse\x12X\n" +
	"\x12GetDocumentVersion\x12%.service.v1.GetDocumentVersionRequest\x1a\x1b.service.v1.DocumentVersion\x12Q\n" +
	...
	"\x16RequestWorkflowChanges\x12).service.v1.RequestWorkflowChangesRequest\x1a\x1c.service.v1.WorkflowInstance\x12K\n" +
	"\vGetWorkflow\x12\x1e.service.v1.GetWorkflowRequest\x1a\x1c.service.v1.WorkflowInstance\x12c\n" +
	"\x12ListWorkflowEvents\x12%.service.v1.ListWorkflowEventsRequest\x1a&.service.v1.ListWorkflowEventsResponse\x12Z\n" +
	"\x0fArchiveDocument\x12\".service.v1.ArchiveDocumentRequest\x1a#.service.v1.ArchiveDocumentResponse\x12c\n" +
	"\x12ListActivityEvents\x12%.service.v1.ListActivityEventsRequest\x1a&.service.v1.ListActivityEventsResponse2\x8b\x04\n" +
	...
	"\fSearchGlobal\x12\x1f.service.v1.SearchGlobalRequest\x1a .service.v1.SearchGlobalResponse\x12]\n" +
	"\x10EmitNotification\x12#.service.v1.EmitNotificationRequest\x1a$.service.v1.EmitNotificationResponse\x12u\n" +
	"\x18RetryFailedNotifications\x12+.service.v1.RetryFailedNotificationsRequest\x1a,.service.v1.RetryFailedNotificationsResponse2\xa5\x02\n" +
	...
	"\x10EmitNotification\x12#.service.v1.EmitNotificationRequest\x1a$.service.v1.EmitNotificationResponse\x12u\n" +
	"\x18RetryFailedNotifications\x12+.service.v1.RetryFailedNotificationsRequest\x1a,.service.v1.RetryFailedNotificationsResponse2\xae\v\n" +
	...
	"\n" +
	"CreateTask\x12\x1d.service.v1.CreateTaskRequest\x1a\x1e.service.v1.CreateTaskResponse\x12H\n" +
	"\tListTasks\x12\x1c.service.v1.ListTasksRequest\x1a\x1d.service.v1.ListTasksResponse\x12]\n" +
	"\x10UpdateTaskStatus\x12#.service.v1.UpdateTaskStatusRequest\x1a$.service.v1.UpdateTaskStatusResponse\x12c\n" +
	"\x12UpdateTaskAssignee\x12%.service.v1.UpdateTaskAssigneeRequest\x1a&.service.v1.UpdateTaskAssigneeResponse\x12c\n" +
	...
	"\x12AddTaskBoardMember\x12%.service.v1.AddTaskBoardMemberRequest\x1a&.service.v1.AddTaskBoardMemberResponse\x12u\n" +
	"\x18CreateOrganizationMember\x12+.service.v1.CreateOrganizationMemberRequest\x1a,.service.v1.CreateOrganizationMemberResponseB\x18Z\x16edo/shared/proto/pb;pbb\x06proto3"
...
var file_service_proto_depIdxs = []int32{
	...
	74, // 59: service.v1.SignatureService.StartSignature:input_type -> service.v1.StartSignatureRequest
	76, // 60: service.v1.SignatureService.RecordSignatureCallback:input_type -> service.v1.RecordSignatureCallbackRequest
	77, // 61: service.v1.SignatureService.GetSignatureStatus:input_type -> service.v1.GetSignatureStatusRequest
	83, // 62: service.v1.NotificationService.CreateNotification:input_type -> service.v1.CreateNotificationRequest
	85, // 63: service.v1.NotificationService.ListNotifications:input_type -> service.v1.ListNotificationsRequest
	87, // 64: service.v1.NotificationService.MarkNotificationRead:input_type -> service.v1.MarkNotificationReadRequest
	89, // 65: service.v1.NotificationService.GetUnreadCount:input_type -> service.v1.GetUnreadCountRequest
	78, // 66: service.v1.NotificationService.EmitNotification:input_type -> service.v1.EmitNotificationRequest
	80, // 67: service.v1.NotificationService.RetryFailedNotifications:input_type -> service.v1.RetryFailedNotificationsRequest
	28, // 68: service.v1.TaskOrchestrationService.CreateTaskBoard:input_type -> service.v1.CreateTaskBoardRequest
	16, // 69: service.v1.TaskOrchestrationService.CreateTask:input_type -> service.v1.CreateTaskRequest
	18, // 70: service.v1.TaskOrchestrationService.ListTasks:input_type -> service.v1.ListTasksRequest
	20, // 71: service.v1.TaskOrchestrationService.UpdateTaskStatus:input_type -> service.v1.UpdateTaskStatusRequest
	22, // 72: service.v1.TaskOrchestrationService.UpdateTaskAssignee:input_type -> service.v1.UpdateTaskAssigneeRequest
	24, // 73: service.v1.TaskOrchestrationService.AddTaskAttachments:input_type -> service.v1.AddTaskAttachmentsRequest
	26, // 74: service.v1.TaskOrchestrationService.RemoveTaskAttachment:input_type -> service.v1.RemoveTaskAttachmentRequest
	29, // 75: service.v1.TaskOrchestrationService.ListTaskBoards:input_type -> service.v1.ListTaskBoardsRequest
	27, // 76: service.v1.TaskOrchestrationService.GetTaskBoard:input_type -> service.v1.GetTaskBoardRequest
	35, // 77: service.v1.TaskOrchestrationService.GetTaskDetails:input_type -> service.v1.GetTaskDetailsRequest
	37, // 78: service.v1.TaskOrchestrationService.GetAvailableApprovers:input_type -> service.v1.AvailableApproversRequest
	46, // 79: service.v1.TaskOrchestrationService.GetAvailableDocuments:input_type -> service.v1.AvailableDocumentsRequest
	39, // 80: service.v1.TaskOrchestrationService.ListOrganizationMembers:input_type -> service.v1.ListOrganizationMembersRequest
	41, // 81: service.v1.TaskOrchestrationService.AddTaskBoardMember:input_type -> service.v1.AddTaskBoardMemberRequest
	43, // 82: service.v1.TaskOrchestrationService.CreateOrganizationMember:input_type -> service.v1.CreateOrganizationMemberRequest
	4,  // 83: service.v1.ExampleService.Ping:output_type -> service.v1.PingResponse
	5,  // 84: service.v1.DocumentWorkflowService.CreateDraft:output_type -> service.v1.Document
	5,  // 85: service.v1.DocumentWorkflowService.UpdateDraft:output_type -> service.v1.Document
	5,  // 86: service.v1.DocumentWorkflowService.GetDocument:output_type -> service.v1.Document
	7,  // 87: service.v1.DocumentWorkflowService.GetEditorControlProfile:output_type -> service.v1.EditorControlProfile
	7,  // 88: service.v1.DocumentWorkflowService.UpdateEditorControlProfile:output_type -> service.v1.EditorControlProfile
	9,  // 89: service.v1.DocumentWorkflowService.CreateExportRequest:output_type -> service.v1.ExportRequest
	9,  // 90: service.v1.DocumentWorkflowService.GetExportRequest:output_type -> service.v1.ExportRequest
	57, // 91: service.v1.DocumentWorkflowService.DownloadExportArtifact:output_type -> service.v1.DownloadExportArtifactResponse
	59, // 92: service.v1.DocumentWorkflowService.SearchDocuments:output_type -> service.v1.SearchDocumentsResponse
	61, // 93: service.v1.DocumentWorkflowService.ListDocumentVersions:output_type -> service.v1.ListDocumentVersionsResponse
	6,  // 94: service.v1.DocumentWorkflowService.GetDocumentVersion:output_type -> service.v1.DocumentVersion
	10, // 95: service.v1.DocumentWorkflowService.SubmitWorkflow:output_type -> service.v1.WorkflowInstance
	10, // 96: service.v1.DocumentWorkflowService.ApproveWorkflow:output_type -> service.v1.WorkflowInstance
	10, // 97: service.v1.DocumentWorkflowService.RequestWorkflowChanges:output_type -> service.v1.WorkflowInstance
	10, // 98: service.v1.DocumentWorkflowService.GetWorkflow:output_type -> service.v1.WorkflowInstance
	12, // 99: service.v1.DocumentWorkflowService.ListWorkflowEvents:output_type -> service.v1.ListWorkflowEventsResponse
	64, // 100: service.v1.DocumentWorkflowService.ArchiveDocument:output_type -> service.v1.ArchiveDocumentResponse
	98, // 101: service.v1.DocumentWorkflowService.ListActivityEvents:output_type -> service.v1.ListActivityEventsResponse
	92, // 102: service.v1.SearchNotificationService.SyncSearchProjection:output_type -> service.v1.SyncSearchProjectionResponse
	59, // 103: service.v1.SearchNotificationService.SearchDocuments:output_type -> service.v1.SearchDocumentsResponse
	95, // 104: service.v1.SearchNotificationService.SearchGlobal:output_type -> service.v1.SearchGlobalResponse
	79, // 105: service.v1.SearchNotificationService.EmitNotification:output_type -> service.v1.EmitNotificationResponse
	81, // 106: service.v1.SearchNotificationService.RetryFailedNotifications:output_type -> service.v1.RetryFailedNotificationsResponse
	48, // 107: service.v1.SignatureService.StartSignature:output_type -> service.v1.SignatureRequest
	48, // 108: service.v1.SignatureService.RecordSignatureCallback:output_type -> service.v1.SignatureRequest
	48, // 109: service.v1.SignatureService.GetSignatureStatus:output_type -> service.v1.SignatureRequest
	84, // 110: service.v1.NotificationService.CreateNotification:output_type -> service.v1.CreateNotificationResponse
	86, // 111: service.v1.NotificationService.ListNotifications:output_type -> service.v1.ListNotificationsResponse
	88, // 112: service.v1.NotificationService.MarkNotificationRead:output_type -> service.v1.MarkNotificationReadResponse
	90, // 113: service.v1.NotificationService.GetUnreadCount:output_type -> service.v1.GetUnreadCountResponse
	79, // 114: service.v1.NotificationService.EmitNotification:output_type -> service.v1.EmitNotificationResponse
	81, // 115: service.v1.NotificationService.RetryFailedNotifications:output_type -> service.v1.RetryFailedNotificationsResponse
	34, // 116: service.v1.TaskOrchestrationService.CreateTaskBoard:output_type -> service.v1.CreateTaskBoardResponse
	17, // 117: service.v1.TaskOrchestrationService.CreateTask:output_type -> service.v1.CreateTaskResponse
	19, // 118: service.v1.TaskOrchestrationService.ListTasks:output_type -> service.v1.ListTasksResponse
	21, // 119: service.v1.TaskOrchestrationService.UpdateTaskStatus:output_type -> service.v1.UpdateTaskStatusResponse
	23, // 120: service.v1.TaskOrchestrationService.UpdateTaskAssignee:output_type -> service.v1.UpdateTaskAssigneeResponse
	25, // 121: service.v1.TaskOrchestrationService.AddTaskAttachments:output_type -> service.v1.AddTaskAttachmentsResponse
	15, // 122: service.v1.TaskOrchestrationService.RemoveTaskAttachment:output_type -> service.v1.Task
	32, // 123: service.v1.TaskOrchestrationService.ListTaskBoards:output_type -> service.v1.ListTaskBoardsResponse
	33, // 124: service.v1.TaskOrchestrationService.GetTaskBoard:output_type -> service.v1.GetTaskBoardResponse
	36, // 125: service.v1.TaskOrchestrationService.GetTaskDetails:output_type -> service.v1.GetTaskDetailsResponse
	38, // 126: service.v1.TaskOrchestrationService.GetAvailableApprovers:output_type -> service.v1.AvailableApproversResponse
	47, // 127: service.v1.TaskOrchestrationService.GetAvailableDocuments:output_type -> service.v1.AvailableDocumentsResponse
	40, // 128: service.v1.TaskOrchestrationService.ListOrganizationMembers:output_type -> service.v1.ListOrganizationMembersResponse
	42, // 129: service.v1.TaskOrchestrationService.AddTaskBoardMember:output_type -> service.v1.AddTaskBoardMemberResponse
	44, // 130: service.v1.TaskOrchestrationService.CreateOrganizationMember:output_type -> service.v1.CreateOrganizationMemberResponse
