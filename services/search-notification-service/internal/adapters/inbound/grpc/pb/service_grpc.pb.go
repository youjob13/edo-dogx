...
const (
	...
	SearchNotificationService_SearchGlobal_FullMethodName             = "/service.v1.SearchNotificationService/SearchGlobal"
...
func (c *searchNotificationServiceClient) SearchGlobal(ctx context.Context, in *SearchGlobalRequest, opts ...grpc.CallOption) (*SearchGlobalResponse, error) {
	...
	err := c.cc.Invoke(ctx, SearchNotificationService_SearchGlobal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SearchNotificationService_SearchGlobal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SearchNotificationService_SearchGlobal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	NotificationService_CreateNotification_FullMethodName       = "/service.v1.NotificationService/CreateNotification"
	NotificationService_ListNotifications_FullMethodName        = "/service.v1.NotificationService/ListNotifications"
	NotificationService_MarkNotificationRead_FullMethodName     = "/service.v1.NotificationService/MarkNotificationRead"
	NotificationService_GetUnreadCount_FullMethodName           = "/service.v1.NotificationService/GetUnreadCount"
